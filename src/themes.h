...
/* ── Core colour type (used throughout the project) ─────────────── */
...
/* ── Layout constants needed by dot placement ───────────────────── */
#define TITLE_H   34
#define TB_BTN_W  40
...
/* ── Live colour slots (interpolated at runtime) ────────────────── */
...
extern int   dots_x0;
extern int   dots_cy;
extern float tc_t;   /* colour transition progress — 1.0 = complete */
extern float galaxy_dot_f; /* 0..1 — animates in when Galaxy theme is selected */

/* ── Search bar layout (set by compute_dot_layout) ──────────────── */
extern int   sr_x;
extern int   sr_w;
